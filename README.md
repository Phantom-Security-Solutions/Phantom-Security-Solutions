...
- This script scan with nmap using the flag -vuln to find vulnerabilities, then it parses the scan results to metaspploit, searching their data base with the information from teh scan and attept the exploits found. 
